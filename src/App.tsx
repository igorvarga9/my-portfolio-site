...
import { bookOutline, calendarOutline, chevronDown, closeOutline, eye, eyeOutline, locationOutline, logoFacebook, logoGithub, logoTwitch, logoTwitter, mailOutline, paperPlane, phonePortraitOutline } from 'ionicons/icons';
